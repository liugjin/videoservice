...
exports.h264Settings = (media, date, trackId) => {
    ...
    if(!media.fmtp.parameters['sprop-parameter-sets']){
        media.fmtp.parameters['sprop-parameter-sets']=sessionStorage.getItem("sps_pps");
    }
    else {
        sessionStorage.setItem("sps_pps", media.fmtp.parameters['sprop-parameter-sets']);
    }
